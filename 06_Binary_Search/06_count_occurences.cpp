...
int count(vector<int>& arr, int arr_size, int value) {
    int first = first_using_plain_binary(arr, arr_size, value);
    int last = last_using_plain_binary(arr, arr_size, value);
...
int main()
{
    ...
    cout <<  "Number of occurences: " << (result.second - result.first + 1);
    cout << endl;

    cout << "First occurrence(using STL): " << result2.first << endl;
    cout << "Last occurrence(using STL): " << result2.second << endl;
    cout <<  "Number of occurences: " << (result2.second - result2.first + 1);
